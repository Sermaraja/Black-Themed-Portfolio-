...
export const SEOIcon = ({ isActive }: { isActive?: boolean }) => (
  <img 
    src="https://res.cloudinary.com/dlbeckur1/image/upload/v1782229169/PinClipart.com_antique-clip-art_183326_awftlf.png" 
    alt="SEO" 
...
export const ContentCreationIcon = ({ isActive }: { isActive?: boolean }) => (
  <svg className={`w-12 h-12 transition-all duration-300 ${isActive ? "filter-none brightness-100 opacity-100" : "filter grayscale brightness-75 opacity-60 group-hover:grayscale-0 group-hover:brightness-100 group-hover:opacity-100"}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg">
    <defs>
    ...
    <path stroke="url(#content-grad)" d="M12 20h9" />
    <path stroke="url(#content-grad)" d="M16.5 3.5a2.121 2.121 0 013 3L7 19l-4 1 1-4L16.5 3.5z" fill="url(#content-grad)" fillOpacity="0.2" />
  </svg>
);

export const AffinityIcon = ({ isActive }: { isActive?: boolean }) => (
  <img 
    src="https://img.icons8.com/fluency/50/affinity-designer.png" 
    alt="Affinity Designer" 
    className={`w-12 h-12 transition-all duration-300 object-contain ${isActive ? "filter-none brightness-100 opacity-100" : "filter grayscale brightness-75 opacity-60 group-hover:grayscale-0 group-hover:brightness-100 group-hover:opacity-100"}`}
  />
);

export const MobiriseIcon = ({ isActive }: { isActive?: boolean }) => (
  <img 
    src="https://res.cloudinary.com/dlbeckur1/image/upload/v1782229176/408-4085294_mobirise-4-official-logo-mobirise-icon-clipart_krgzc8.png" 
    alt="Mobirise" 
    className={`w-12 h-12 transition-all duration-300 object-contain ${isActive ? "filter-none brightness-100 opacity-100" : "filter grayscale brightness-75 opacity-60 group-hover:grayscale-0 group-hover:brightness-100 group-hover:opacity-100"}`}
  />
);
